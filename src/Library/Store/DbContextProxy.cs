// -----------------------------------------------------------------------
// <copyright file="DbContextProxy.cs" Company="Lensgrinder, Ltd.">
...
namespace Infrastructure.DataAccess
{
    ...
    /// <summary>
    /// Common base class Datasource over DbContext.
    /// </summary>
    public abstract class DbContextProxy : DbContext, IDatasource
    {
        /// <summary>
        /// Initializes a new instance of the DbContextProxy class.
        /// </summary>
        /// <param name="connectionString">The connection string.</param>
        protected DbContextProxy(string connectionString)
        ...
        {
            return ConfigurationHelper.BuildModel(this, null);
        }
        ...
        public virtual IQueryable<T> Get<T>(params string[] includes)
            where T : class
        {
            IQueryable<T> result = this.Set<T>();
        ...
        public virtual InfrastructureKey CreateKey(string entitySetName, object entity)
        {
            ...
            {
                throw new ObjectNotFoundException(entitySetName);
            }
            ...
            where T : class
        {
            ...
            this.Set<T>().Remove(originalEntity);
            if (this.CurrentTransaction == null)
            {
                this.SaveChanges();
            }
        ...
        public virtual IQueryable<T> Execute<T>(ParsedOperation operation)
        {
            ...
            return adapter.ObjectContext.ExecuteFunction<T>(operation.Name, operation.Parameters.ToArray())
                .AsQueryable<T>();
        }
        ...
        public virtual int Execute(ParsedOperation operation)
        {
            ...
            return adapter.ObjectContext.ExecuteFunction(operation.Name, operation.Parameters.ToArray());
        }
            ...
            where T : class
        {
            ...
            if (value != null)
            {
                ...
                ObjectStateEntry entry;
                if (adapter.ObjectContext.ObjectStateManager.TryGetObjectStateEntry(key, out entry) == true &&
            ...
            where T : class
        {
            ...
            this.Set<T>().Attach(originalEntity);
