// -----------------------------------------------------------------------
// <copyright file="TSqlSerializer.cs" company="Lensgrinder, Ltd.">
...
namespace Infrastructure.DataAccess
{
    ...
    /// </summary>
    internal class TSqlSerializer
    {
        /// <summary>
        /// Query serializer.
        /// </summary>
        private TSqlQuerySerializer serializer = new TSqlQuerySerializer();
        ...
        internal string SerializeAggregateColumn(AggregateColumnReference acr, List<QueryColumn> nestedColumns, ParameterContext context)
        {
            ...
            else
            {
                ...
                TSqlFilterSerializer qc = new TSqlFilterSerializer(null);
        ...
        internal string SerializeJoin(QueryJoin join, ParameterContext context, SqlFormatter formatter)
        {
            if (join.IntermediateTable == null)
            {
                ...
                {
                    TSqlFilterSerializer qc = new TSqlFilterSerializer(join.TargetNode);
