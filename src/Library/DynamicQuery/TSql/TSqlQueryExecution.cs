// -----------------------------------------------------------------------
// <copyright file="TSqlQueryExecution.cs" company="Lensgrinder, Ltd.">
...
namespace Infrastructure.DataAccess
{
    ...
    /// <summary>
    /// TSql Query Execution implementation.
    /// </summary>
    internal class TSqlQueryExecution : IExecutor
    {
        /// <summary>
        /// The instance's projection helper.
        /// </summary>
        private IProjectionHelper projectionHelper = new TSqlProjectionHelper();
            ...
            TimeSpan? timeout = null)
        {
            ...
            string commandText = TSqlQuerySerializer.Serialize(query, new ParameterContext(), formatter)
                .Insert(0, "-- AutoGenerated By DataAccess\n");
            string parameterText = TSqlQuerySerializer.SerializeParameterDeclaration(query);
            ...
            sp.Name = "dbo.sp_executesql";
            sp.Timeout = timeout;
            sp.Assign("stmt", commandText);
            sp.Assign("params", parameterText);
            ...
            TimeSpan? timeout = null)
        {
            ...
            string commandText = TSqlQuerySerializer.SerializeMerge(merge, isSingleEntity).Insert(0, "-- AutoGenerated By DataAccess\n");
            string parameterText = TSqlQuerySerializer.SerializeParameterDeclaration(merge.Target);
            DynamicProcedure<T> sp = null;
            if (shardId == null)
            {
                sp = new DynamicProcedure<T>(databaseType);
        ...
        public StoredProcedureNonQuery CompileDeletes(
            ...
            TimeSpan? timeout = null)
        {
            string commandText = TSqlQuerySerializer.SerializeDeletes(deletes).Insert(0, "-- AutoGenerated By DataAccess\n");
            string parameterText = TSqlQuerySerializer.SerializeParameterDeclaration(deletes.First().Target);
        ...
        public StoredProcedureNonQuery CompileInserts(
            ...
            TimeSpan? timeout = null)
        {
            string commandText = TSqlQuerySerializer.SerializeInserts(inserts).Insert(0, "-- AutoGenerated By DataAccess\n");
            string parameterText = TSqlQuerySerializer.SerializeParameterDeclaration(inserts.First().Target);
        ...
        {
            return TSqlQuerySerializer.Serialize(query, context, formatter);
        }
    }
}
