// -----------------------------------------------------------------------
// <copyright file="MySqlProjectionHelper.cs" company="Lensgrinder, Ltd.">
...
namespace Infrastructure.DataAccess
{
    ...
    /// </summary>
    internal class MySqlProjectionHelper : IProjectionHelper
    {
        /// <summary>
        ...
        internal static string Serialize(SelectQuery query)
        {
            ...
            StringBuilder builder = new StringBuilder("CREATE TEMPORARY TABLE sys.`#Path` (\nId bigint AUTO_INCREMENT PRIMARY KEY");
            string separator = ",";
            ...
            builder.AppendLine(");");
            builder.Append("INSERT sys.`#Path` (");
            ...
            builder.Append("CREATE TEMPORARY TABLE sys.`#UnionHack` (SeedId nvarchar(1024), ChildId nvarchar(1024), ComponentId nvarchar(1024) );\n");
            builder.Append("INSERT sys.`#UnionHack`\n");
            ...
            builder.AppendLine("SELECT DISTINCT * FROM sys.`#UnionHack`;\n");
        ...
        private static string SwitchToSqlTypeName(string name)
        {
            switch (name)
            {
                ...
                case "String": return "nvarchar(1024)";
                case "Guid": return "char(16)";
